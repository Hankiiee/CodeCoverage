...
export default class Scatterplot {
  ...
  paintScatterplot(element, layout, selectionAPI) {
    ...
    console.log(layout.qHyperCube.qDataPages[0].qMatrix[0][0].qElemNumber);
    const arr = layout.qHyperCube.qDataPages[0].qMatrix[0]; 
    arr.forEach(item => {
      console.log("hej" + item.qElemNumber); // output: 1 2 3 4 5 6
    });
    console.log("Tja");
    const settings = {
      collections: [
